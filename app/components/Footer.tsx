...
const links = {
  Product: ["Features", "How it works", "Architecture", "Pricing", "Changelog"],
  Developers: ["Docs", "API reference", "SDK", "GitHub", "Status"],
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-10">
          ...
          <div className="col-span-2 sm:col-span-3 lg:col-span-1">
            <Link href="/" className="flex items-center gap-2 font-semibold text-lg text-white mb-3">
            ...
            <p className="text-sm text-gray-500 leading-relaxed">
              AI agent coordination for production engineering teams.
            </p>
          </div>
        ...
        {/* Bottom bar */}
        <div className="mt-16 pt-8 border-t border-[var(--border)] flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-600">
          <p>© {new Date().getFullYear()} Murmur. All rights reserved.</p>
